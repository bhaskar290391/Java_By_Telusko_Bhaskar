...
const Home = ({ selectedCategory }) => {
  ...
  // Function to convert base64 string to data URL or handle URLs
  const convertBase64ToDataURL = (base64String, mimeType = 'image/jpeg') => {
    ...
    // If it starts with '/', treat as relative URL from backend
    if (base64String.startsWith('/')) {
      return `${import.meta.env.VITE_BASE_URL}${base64String}`;
    }
